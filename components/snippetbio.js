...
export default function SnippetBio({children})    {
    ...
    return (
        ...
        <Box minH="10px" ml={12} my='6' w='100%' >
                <Center><Image src='/images/profilepic.jpg' borderRadius='full' boxSize='calc(85px + 7.5vw)' mb='5' border='3px solid white' boxShadow={useColorModeValue('lg', 'dark-lg')}/></Center>
